 ...
 *
 */
public class FirstProjectCallOutSuccessActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, DatePickerDialog.OnDateSetListener, MediaPlayer.OnCompletionListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.activity_calloutsuccess_et_upkeeptime:
                ...
                break;
            case R.id.activity_calloutsucces_et_lostreason:
