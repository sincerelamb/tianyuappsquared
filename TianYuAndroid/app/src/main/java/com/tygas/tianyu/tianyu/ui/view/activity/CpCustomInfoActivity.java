...
//                tv_intention_garde.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG);
                ...
                tv_date_yujihuifang.setHint("必填");
                tv_date_yujihuifang.setHintTextColor(getResources().getColor(R.color.appOrange));
...
//        }
        ...
        if (TextUtils.isEmpty(cpData.getIsDrive())) {
            ...
            flag = false;
        } else if (TextUtils.isEmpty(cpData.getNextCallTime())) {
            Toast.makeText(CpCustomInfoActivity.this, "未选择预计回访时间", Toast.LENGTH_SHORT).show();
            flag = false;
