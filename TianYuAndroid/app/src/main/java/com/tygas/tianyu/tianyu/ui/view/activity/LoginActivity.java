                            ...
                            if (user != null &&
                                ...
                                if (projectCode.equals(XutilsRequest.PC)) {
                                    try {
                                        ...
                                        dbUtils.saveAll(user.getList_IntentBrand());
                                        ...
                                        dbUtils.saveAll(user.getList_PayType());
                                        dbUtils.saveAll(user.getList_WishBuyDate());
                                        dbUtils.saveAll(user.getList_TimeFrame());
                                        dbUtils.saveAll(user.getList_AllEmpID());
                                        Log.d("leaele", user.getList_LevelAll().toString());
//                                        dbUtils.saveAll(user.getList_PID());
                                        ((MyAppCollection) getApplicationContext()).setUser(user);
                                    } catch (DbException e) {
                                        e.printStackTrace();
