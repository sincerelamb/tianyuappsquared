...
public class FP_CustomerInfo_Fragment extends Fragment {
    ...
    private void initView() {
        ...
        TextView tv_milemaintaindate = (TextView) inflate.findViewById(R.id.fragment_fpcustomersinfo_tv_milemaintaindata);
        tv_milemaintaindate.setText(firstProtect.getLatelyMaintainDate());
        TextView tv_datemaintaindate = (TextView) inflate.findViewById(R.id.fragment_fpcustomersinfo_tv_datemaintaindata);
        tv_datemaintaindate.setText(firstProtect.getPredictDate());
