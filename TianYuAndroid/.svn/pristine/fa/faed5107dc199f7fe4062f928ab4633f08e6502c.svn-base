...
//                        }
            ...
            case R.id.activity_cpinfo_rl_city:
                if (!TextUtils.isEmpty(province)) {
                    ...
                    if (list_city != null && list_city.size() > 0) {
                        ...
                        Toast.makeText(CpCustomInfoActivity.this, "请重新选择省", Toast.LENGTH_SHORT).show();
                    }
            ...
            case R.id.activity_cpinfo_rl_area:
                if (!TextUtils.isEmpty(city)) {
                    ...
                    if (null != list_area && list_area.size() > 0) {
                        ...
                        Toast.makeText(CpCustomInfoActivity.this, "请重新选择市", Toast.LENGTH_SHORT).show();
                    }
    ...
    private boolean checkSaveDate() {
        ...
        if (TextUtils.isEmpty(cpData.getIsDrive())) {
            ...
            Toast.makeText(CpCustomInfoActivity.this, "未填写报价", Toast.LENGTH_SHORT).show();
            flag = false;
