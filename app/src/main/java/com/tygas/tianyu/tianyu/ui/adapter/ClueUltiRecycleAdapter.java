...
public class ClueUltiRecycleAdapter extends UltimateViewAdapter<ClueUltiRecycleAdapter.ClueViewHodler> {
    ...
    public ClueUltiRecycleAdapter(ClueActivity clueActivity, ArrayList<Clue> data) {
        this.data = data;
    ...
    public void onBindViewHolder(ClueViewHodler holder, int position) {
        ...
        final Clue clue = data.get(position);
            ...
            public void onClick(View v) {
                ...
                if (!PhoneValidate.validateNumber(clue.getCluePhone())) {
                    ...
                    if (ActivityCompat.checkSelfPermission(clueActivity, Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED &&
                        ...
                        intent.setData(data);
                        RecordFile recordFile = new RecordFile(clueActivity, "clue" + clue.getClueName() + clue.getCluePhone());
                        PhonStateLisen.setParamsForClue(clueActivity, clue,
    ...
    class ClueViewHodler extends UltimateRecyclerviewViewHolder {
        ...
        public void setValueFromClue(Clue c) {
            nameTextView.setText(c.getClueName());
            phoneTextView.setText(c.getCluePhone());
