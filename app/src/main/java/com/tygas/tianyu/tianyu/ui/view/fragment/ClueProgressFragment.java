 ...
 */
public class ClueProgressFragment extends Fragment implements View.OnClickListener {
    ...
    private void initData() {
        RequestParams requestParams = XutilsRequest.getClue(clue.getClueId());
    ...
    private void parseJson(String result) throws JSONException {
        ...
        if(result != null && result.length() > 0){
            ...
            if("Success".equals(status)){
                ...
                Toast.makeText(getActivity(),"数据错误"+jsonObject.getString("message"),Toast.LENGTH_SHORT).show();
