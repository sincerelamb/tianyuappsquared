 ...
 */
public class CustomersInfoFragment extends Fragment implements View.OnClickListener {
    ...
    private TextView customerFrom;
    private TextView channeName;//来电渠道
    ...
    private TextView changeTextView;//新购置换

    private TextView quotesituationTextView;//报价情况

    private GridView gridView;
    private Button calloutButton;//电话播出
    ...
    private void initView() {
        if(root != null && customer != null){
            ...
            customerFrom = (TextView) root.findViewById(R.id.fragment_customersinfo_tv_contactType);
            customerFrom.setText(customer.getContactType());
            ...
            person = (TextView) root.findViewById(R.id.fragment_customersinfo_tv_person);
            person.setText(customer.getIntroducer());
            ...
            changeTextView = (TextView) root.findViewById(R.id.fragment_customersinfo_tv_change);
            changeTextView.setText(customer.getIsChange());

            //设置关注特征
            calloutButton = (Button) root.findViewById(R.id.frgment_customersinfo_bt_callout);
                ...
                if(!PhoneValidate.validateNumber(customer.getCustomerPhone())){//电话又字符串则返回true
                    ...
                    if (ActivityCompat.checkSelfPermission(activity, Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED &&
                        ...
                        PhonStateLisen.setParamsForPtCustomer(activity, customer,
                                new RecordFile(activity,customer.getCustomerName()+customer.getCustomerPhone()).getFilePath());
