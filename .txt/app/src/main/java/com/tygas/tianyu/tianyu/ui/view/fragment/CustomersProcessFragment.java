 ...
 */
public class CustomersProcessFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        footer = root.findViewById(R.id.frgment_customersinfo_bt_callout);
        footer.setOnClickListener(this);
        customer = (PtCustomer) getArguments().get("data");
        Log.i(LOG_TAG,"[潜客详细信息]");
        return root;
    }
    ...
    public void initData(){
        ...
        utils.send(HttpRequest.HttpMethod.POST, UrlData.PC_URL, requestParams, new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                Log.i(LOG_TAG,"[潜客详情返回的数据]"+responseInfo.result);
