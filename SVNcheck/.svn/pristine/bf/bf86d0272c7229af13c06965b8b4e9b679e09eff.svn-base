...
public class User implements Serializable {
    ...
    private List<UserPtInfoModel> list_IntentBrand;

    public List<UserPtInfoModel> getList_IntentBrand() {
        return list_IntentBrand;
    }

    public void setList_IntentBrand(List<UserPtInfoModel> list_IntentBrand) {
        this.list_IntentBrand = list_IntentBrand;
    }
    ...
    private List<UserPtInfoModel> list_PayType;
    private List<UserPtInfoModel> list_WishBuyDate;
    private List<UserPtInfoModel> list_TimeFrame;
    private List<UserPtInfoModel> list_AllEmpID;

    public List<UserPtInfoModel> getList_AllEmpID() {
        return list_AllEmpID;
    }

    public void setList_AllEmpID(List<UserPtInfoModel> list_AllEmpID) {
        this.list_AllEmpID = list_AllEmpID;
    }

    public List<UserPtInfoModel> getList_PayType() {
        return list_PayType;
    }

    public void setList_PayType(List<UserPtInfoModel> list_PayType) {
        this.list_PayType = list_PayType;
    }

    public List<UserPtInfoModel> getList_WishBuyDate() {
        return list_WishBuyDate;
    }

    public void setList_WishBuyDate(List<UserPtInfoModel> list_WishBuyDate) {
        this.list_WishBuyDate = list_WishBuyDate;
    }

    public List<UserPtInfoModel> getList_TimeFrame() {
        return list_TimeFrame;
    }

    public void setList_TimeFrame(List<UserPtInfoModel> list_TimeFrame) {
        this.list_TimeFrame = list_TimeFrame;
    }
