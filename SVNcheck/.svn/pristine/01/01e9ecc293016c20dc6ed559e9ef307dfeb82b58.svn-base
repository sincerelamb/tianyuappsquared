...
public class ClueProgressAdapter extends BaseAdapter {
    ...
    public ClueProgressAdapter(ArrayList<ClueProgress> datas, PtCustomer clue, String userName) {
        this.datas = datas;
        this.clue = clue;
    ...
    class ClueProgressViewHolder {
        ...
        public void setValue(ClueProgress clueProgress) {
            nameTextView.setText(clue.getCustomerName());
            ...
            Log.d("sss", clueProgress.getCusComeDate());
            recordTextView.setText(clueProgress.getTalkProcess());
            empNameTextView.setText("接触人:" + clueProgress.getEmpName());
        }
