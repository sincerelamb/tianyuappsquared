...
public class PhonStateLisen extends PhoneStateListener {
    ...
    public static void setParamsForFpCustomer(Activity a, FirstProtect firstProtect, String path) {
        activity = a;
    ...
    public static void setParamsForTpCustomer(Activity a, TimingProtect timingProtect, String path) {
        activity = a;
