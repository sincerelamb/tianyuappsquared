    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.activity_addnewtreach_tv_province://点击了常住省
                new MyDialogHelper().showListDialog(this, "请选择", provinces, (TextView) v, new MyDialogHelper.DialogCallBack() {
                    @Override
            ...
            case R.id.activity_addnewtreach_tv_permanent://点击了常住市
                if(provinceName != null && provinceName.length() > 1)
                new MyDialogHelper().showListDialog(this,"请选择",getPermentsNameFromPosition(provinceName), (TextView) v,new MyDialogHelper.DialogCallBack(){

                    @Override
                    public void callBack(int position) {
                        perName = getPermentsNameFromPosition(provinceName).get(position);
                        countyTextView.setText("请选择");
            ...
            case R.id.activity_addnewtreach_tv_county://点击了常住县
                if(perName != null && perName.length() > 1){
                    new MyDialogHelper().showListDialog(this,"请选择",getCountyFromPosition(provinceName,perName), (TextView) v);
                }
                break;
            ...
            case R.id.activity_addnewtreach_tv_receptionActv://点击了外展活动
                new MyDialogHelper().showListDialog(this,"请选择",getWaiStringsFromList(), (TextView) v);
                break;
            ...
            case R.id.activity_addnewtreach_tv_intentLevel://点击意向等级
                new MyDialogHelper().showListDialog(this, "请选择", getNamesFromUserPtInfoModel(user.getList_LevelNotDefeat()), (TextView) v, new MyDialogHelper.DialogCallBack() {
                    @Override
                    public void callBack(int position) {
            ...
            case R.id.activity_addnewtreach_tv_carUse://购车用途
                ...
                break;
            case R.id.activity_addnewtreach_tv_newChange://购置新换
                new MyDialogHelper().showListDialog(this,"请选择",Arrays.asList(USE), (TextView) v);
                break;
            case R.id.activity_addnewtreach_tv_mortgage://是否按揭
                new MyDialogHelper().showListDialog(this,"请选择",Arrays.asList(ANJIE), (TextView) v);
                break;
        }
    }  //end onclick
