 ...
 */
public class CallOutFailActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    private static final String LOG_TAG = "CallOutFailActivity";
