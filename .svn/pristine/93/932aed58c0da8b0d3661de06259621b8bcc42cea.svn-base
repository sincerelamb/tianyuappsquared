 ...
 */
public class TimingProjectCallOutFailActivity extends Activity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    private void saveToNet() {
        ...
        RequestParams requestParams =
                XutilsRequest.getFirstProjectCallSuccess(
                        ...
                        "0", "",
                        "0", "", "", "", "",
                        user.getEmpId(), "定保", predictDate, null);
        ...
        httpUtils.send(HttpRequest.HttpMethod.POST, UrlData.FIRST_ISSHOURESULT_URL, requestParams, new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(TimingProjectCallOutFailActivity.this, "数据解析出错", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(HttpException e, String s) {
                Toast.makeText(TimingProjectCallOutFailActivity.this, "网络错误", Toast.LENGTH_SHORT).show();
                ProgressDialogHelper.dismissProgressDialog();
            }
        });
    ...
    private void parseResult(String result) throws JSONException {
        ...
        if ("Success".equals(status)) {
            ...
            if ("Success".equals(status)) {
                ...
                finish();
                HttpUtilsHelper.downLoadUpdataUI(TimingProjectCallOutFailActivity.this, false, 0, false, false, false);
