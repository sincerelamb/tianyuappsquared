 ...
 * 维修明细
 */
public class FirstProjectRepairDetailActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void loadDataTest() {
        ...
        new Thread(){
            ...
            public void run() {
                ...
                for(int i=0;i<10;i++){
                    ...
                    repairProject.setServiceGroupName("xxxxx00001212");
                    repairProject.setAmountTotal("123");
                    repairProject.setProjectName("xxxxxxxxxxxxxxxxx");
        ...
        new Thread(){
            ...
            public void run() {
                ...
                for(int i=0;i<10;i++){
                    PartsDetail detail = new PartsDetail();
                    detail.setTrueSalePriceTotal("125");
                    detail.setPartCode("20xxxssxsxsxsxsxs");
                    detail.setPartName("xxxxsadasdsad");
